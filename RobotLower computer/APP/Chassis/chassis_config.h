...
/* x跟踪备用参数组:test.c状态机在TEST_POSITION_STATE_START_MOVE_4/WAIT_MOVE_4
   ...
   待整定。 */
#define CHASSIS_TRACK_TRANSLATION_X_ALT_KP (1.2f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_KI (0.0015f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_KD (0.15f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_MAX_OUT (0.45f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_MAX_IOUT (0.03f)
