 ...
 * 待整定。
 */
#define CHASSIS_TRACK_TRANSLATION_X_KP (0.3f)
#define CHASSIS_TRACK_TRANSLATION_X_KI (0.00015f)
#define CHASSIS_TRACK_TRANSLATION_X_KD (0.1f)
#define CHASSIS_TRACK_TRANSLATION_X_MAX_OUT (0.1f)
...
/* x跟踪备用参数组:Core.c的RobotStateUpdateTask状态机在ROBOT_STATE_START_MOVE_4/WAIT_MOVE_4
   ...
   待整定。 */
#define CHASSIS_TRACK_TRANSLATION_X_ALT_KP (0.74f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_KI (0.0001f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_KD (0.1f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_MAX_OUT (0.23f)
...
#define CHASSIS_TRACK_TRANSLATION_X_ALT2_KP (2.05f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT2_KI (0.001f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT2_KD (0.15f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT2_MAX_OUT (1.1f)
...
/* x跟踪第四套参数组:Core.c的RobotStateUpdateTask状态机在ROBOT_STATE_START_MOVE_9(上斜坡)
   阶段切换到这一组,待整定。 */
#define CHASSIS_TRACK_TRANSLATION_X_ALT3_KP (2.05f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT3_KI (0.001f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT3_KD (0.15f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT3_MAX_OUT (1.1f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT3_MAX_IOUT (0.05f)
