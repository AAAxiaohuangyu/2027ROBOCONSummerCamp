 ...
 * 待整定。
 */
#define CHASSIS_TRACK_TRANSLATION_X_KP (0.2f)
#define CHASSIS_TRACK_TRANSLATION_X_KI (0.00015f)
#define CHASSIS_TRACK_TRANSLATION_X_KD (0.1f)
#define CHASSIS_TRACK_TRANSLATION_X_MAX_OUT (0.03f)
#define CHASSIS_TRACK_TRANSLATION_X_MAX_IOUT (0.003f)

/* x跟踪备用参数组:test.c状态机在TEST_POSITION_STATE_START_MOVE_4/WAIT_MOVE_4
   阶段(大幅度x回退运动)临时切换到这一组,离开该阶段后切回上面的默认组,
   待整定。 */
#define CHASSIS_TRACK_TRANSLATION_X_ALT_KP (0.72f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_KI (0.001f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_KD (0.1f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_MAX_OUT (0.375f)
#define CHASSIS_TRACK_TRANSLATION_X_ALT_MAX_IOUT (0.02f)

#define CHASSIS_TRACK_TRANSLATION_KP (1.1f)
#define CHASSIS_TRACK_TRANSLATION_KI (0.0003f)
