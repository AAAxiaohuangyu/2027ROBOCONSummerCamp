 ...
 */
#define CHASSIS_PLAN_TRANSLATION_MAX_ACCEL_MPS2 (4.4f)
#define CHASSIS_PLAN_TRANSLATION_MAX_SPEED_MPS (1.2f)
#define CHASSIS_PLAN_TRANSLATION_MAX_JERK_MPS3 (10.2f)
 ...
 * 待整定。
 */
#define CHASSIS_TRACK_TRANSLATION_X_KP (1.4f)
#define CHASSIS_TRACK_TRANSLATION_X_KI (0.05f)
#define CHASSIS_TRACK_TRANSLATION_X_KD (0.8f)
#define CHASSIS_TRACK_TRANSLATION_X_MAX_OUT (1.5f)
#define CHASSIS_TRACK_TRANSLATION_X_MAX_IOUT (0.25f)

#define CHASSIS_TRACK_TRANSLATION_KP (1.4f)
#define CHASSIS_TRACK_TRANSLATION_KI (0.05f)
#define CHASSIS_TRACK_TRANSLATION_KD (0.8f)
#define CHASSIS_TRACK_TRANSLATION_MAX_OUT (1.5f)
#define CHASSIS_TRACK_TRANSLATION_MAX_IOUT (0.25f)
