 ...
 * 待整定。
 */
#define CHASSIS_TRACK_TRANSLATION_X_KP (0.4f)
#define CHASSIS_TRACK_TRANSLATION_X_KI (0.0002f)
#define CHASSIS_TRACK_TRANSLATION_X_KD (0.1f)
#define CHASSIS_TRACK_TRANSLATION_X_MAX_OUT (0.15f)
#define CHASSIS_TRACK_TRANSLATION_X_MAX_IOUT (0.02f)

#define CHASSIS_TRACK_TRANSLATION_KP (0.9f)
#define CHASSIS_TRACK_TRANSLATION_KI (0.002f)
#define CHASSIS_TRACK_TRANSLATION_KD (0.1f)
#define CHASSIS_TRACK_TRANSLATION_MAX_OUT (0.4f)
#define CHASSIS_TRACK_TRANSLATION_MAX_IOUT (0.04f)
