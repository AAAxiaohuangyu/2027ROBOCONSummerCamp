 ...
 */
#define CHASSIS_PLAN_TRANSLATION_MAX_ACCEL_MPS2  (1.0f)
#define CHASSIS_PLAN_TRANSLATION_MAX_SPEED_MPS   (0.5f)
#define CHASSIS_PLAN_TRANSLATION_MAX_JERK_MPS3   (3.5f)
