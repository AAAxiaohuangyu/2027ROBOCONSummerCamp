...
#define ROBOTICARM_LIFT_FDCAN_HANDLE NULL /* 升降电机(J60)FDCAN句柄,占位待定 */
#define ROBOTICARM_LIFT_ID 0u             /* 升降电机(J60)CAN地址,占位待定 */

#define ROBOTICARM_FORWARD_UART_HANDLE NULL /* 前后平移电机(GO)RS485串口句柄,占位待定 */
#define ROBOTICARM_FORWARD_ID 0u            /* 前后平移电机(GO)RS485地址,占位待定 */
