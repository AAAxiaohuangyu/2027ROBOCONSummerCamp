...
osThreadId_t RobotEncoderUpdateTaskHandle;
const osThreadAttr_t RobotEncoderUpdateTask_attributes = {
  .name = "RobotEncoderUpdateTask",
  .stack_size = 256 * 10,
  .priority = (osPriority_t) osPriorityNormal,
};

osThreadId_t RobotStateUpdateTaskHandle;
const osThreadAttr_t RobotStateUpdateTask_attributes = {
    .name = "RobotStateUpdateTask",
    .stack_size = 256 * 10,
    .priority = (osPriority_t)osPriorityNormal,
};

osThreadId_t RobotRoboticArmUpdateTaskHandle;
const osThreadAttr_t RobotRoboticArmUpdateTask_attributes = {
    .name = "RobotRoboticArmUpdateTask",
    .stack_size = 256 * 10,
    .priority = (osPriority_t)osPriorityNormal,
};

osThreadId_t RobotFlipUpdateTaskHandle;
const osThreadAttr_t RobotFlipUpdateTask_attributes = {
    .name = "RobotFlipUpdateTask",
    .stack_size = 256 * 10,
    .priority = (osPriority_t)osPriorityNormal,
};
